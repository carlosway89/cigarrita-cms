...
<div id="home" ng-repeat="block in page | filter:{category:'slider'}" class="">
	<div class="page-gray" style="">
		<div id="principal_background" style="padding-top:200px;{{block.source}}">
			<!-- {{#each this.posts_list}} -->
			<div  data-object="post" class="transito container" style="display:none"  ng-repeat="post in block.posts">
...
<div id="services" ng-repeat="block in page | filter:{category:'services'}">
	<div class="container page-content  page-white " style="padding-top:20px;min-height: 800px;">
		...
		<div class="row" data-id="posts">
			<!-- {{#each this.posts_list}} -->
			<div data-object="post" class="editable col-md-3 col-sm-3 bottom-20 text-center" ng-repeat="post in block.posts" >
				<div  class="ui raised ">
...
<div id="projects" ng-repeat="block in page | filter:{category:'projects'}">
			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel" >
			  ...
			  <div class="col-md-12 ">
			  	<div class="row carousel-indicators" role="tablist">
			  		<!-- {{#each this.posts_list}} -->
			  		<div class="col-xs-3 pointer " ng-class="{active : $first}" data-target="#carousel-slider" data-slide-to="{{$index}}" ng-repeat="post in block.posts">
			  ...
			  <div class="carousel-inner ui page grid margin-top" role="listbox"  >
			  	...
			  	<!-- {{#each this.posts_list}} -->
			    <div class="item " ng-repeat="post in block.posts" ng-class="{active : $first}">
			    	<div class="">	
...
<div id="contact" ng-repeat="block in page | filter:{category:'contact'}">
	<div class=" page-content page-white " style="padding-top:30px;min-height: 490px;">
		...
		<br>
		<!-- {{#each this.posts_list}} -->
		<div class="container" data-object="post" ng-repeat="post in block.posts">
			<div class="col-md-12"  >
...
<div id="about" ng-repeat="block in page | filter:{category:'about'}">

	<div class="page-footer" style="min-height: 390px;">
		<div class="container">
			<div class="row">
				<!-- {{#each this.posts_list}} -->
				<div class="col-md-3" ng-repeat="post in block.posts" >
					<br>
