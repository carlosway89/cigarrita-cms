...
<head>
	...
	<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/vendor/aloha.min.js"></scri
	...
	$(document).ready(function(){
		...
		$('.editable').click(function(event){
			...
			$('#tool_editor').offset({ top: Y, left:X });
		});
...
<body>
	...
	<div id="tool_editor">
		<button class="btn btn-lg btn-info action-bold">B</button>
		<button class="btn btn-lg btn-info action-italic">I</button>
		<button class="btn btn-lg btn-info action-underline">U</button>
		<button class="btn btn-lg btn-info action-unformat">X</button>
	</div>
