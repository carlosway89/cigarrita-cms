...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/style-panel.css">
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/datatable.css">
	...
	<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/vendor/summernote.min.js"></script> 
	<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/vendor/semantic.min.js"></script>
	<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/vendor/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/vendor/jquery.dataTables.bootstrap.js"></script>
  ...
  <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/models/services.js"></script>
  <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/modules/directives.js"></script>
