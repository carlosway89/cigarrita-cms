...
/**
 * This is the model class for table "post_configuration".
 *
 * The followings are the available columns in table 'post_configuration':
 * @property integer $idpostconfiguration
 ...
 */
class PostConfiguration extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PostConfiguration the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('max_width, max_height, crop, quality, type_source, has_source, has_header, has_subheader, has_teaser, category', 'required'),
			array('max_width, max_height, crop, has_source, has_header, has_subheader, has_teaser', 'numerical', 'integerOnly'=>true),
			array('quality, type_source, category', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idpostconfiguration, max_width, max_height, crop, quality, type_source, has_source, has_header, has_subheader, has_teaser, category', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'idpostconfiguration' => 'Idpostconfiguration',
			'max_width' => 'Max Width',
	...
	public function search()
	{
		...
		$criteria->compare('idpostconfiguration',$this->idpostconfiguration);
