 ...
 *
 * The followings are the available columns in table 'sub_menu':
...
class SubMenu extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idsub_menu, name, url', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'menuSubMenus' => array(self::HAS_MANY, 'MenuSubMenu', 'idsub_menu'),
		);
	}
