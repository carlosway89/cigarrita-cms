...
return 
	array(
        ...
        'login.button'=>'Login',
        'login.error'=>'Incorrect Username/Password or User disabled.',
        //post page labels
        ...
        'panel.configurations'=>'Configuration',
        ...
        'panel.update'=>'Update',
        'panel.none'=>'None',
        'panel.popout.delete'=>'Are your sure you want to delete this Item?',
        //General Attributes
        'panel.table.name'=>'Name',
        'panel.table.state'=>'State',
        'panel.table.state.on'=>'Enable',
        'panel.table.state.off'=>'Disable',
        'panel.table.date'=>'Creation Date',
